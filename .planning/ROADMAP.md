...
- [ ] 03-02-PLAN.md — IPv4 completeness: RFC-5952 + both-family reverse-DNS modules + IPv4 reverse-DNS field (wave 2)
- [ ] 03-05-PLAN.md — SEO/content: metadata + canonical/OG + worked example + FAQ + FAQPage JSON-LD (wave 2)
