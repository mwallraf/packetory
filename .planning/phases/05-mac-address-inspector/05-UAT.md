...
number: 1
name: Messy-input layout integrity at 320px
expected: |
  The input row layout does not break/overflow at 320px, and parse still correctly extracts
  or rejects the 12 hex digits regardless of the surrounding noise.
